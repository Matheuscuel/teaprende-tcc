...
export default function TerapeutaDashboard() {
  ...
  if (!selectedChild && !loading) {
    return (
      <RoleGuard allowedRoles={[ROLES.TERAPEUTA]}>
        <main className="min-h-screen bg-gradient-to-br from-blue-100 via-yellow-50 to-orange-100 p-4 sm:p-6 md:p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 flex justify-between items-center">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-blue-900">Dashboard Terapeuta 🧩</h1>
                <p className="text-blue-700 mt-2">Acompanhe seus pacientes</p>
              </div>
              <button
            ...
            {children.length === 0 ? (
              <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Nenhum paciente atribuído</h2>
                <p className="text-gray-600 mb-6">Entre em contato com o administrador para ter pacientes atribuídos a você.</p>
              </div>
            ) : (
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-blue-900 mb-6 text-center">
                  Selecione qual paciente você deseja acompanhar:
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {children.map((child) => (
                    <button
                      ...
                      className="bg-gradient-to-br from-pink-400 to-pink-500 hover:from-pink-500 hover:to-pink-600 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-white text-left"
                    >
  ...
  // Dashboard com paciente selecionado
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: `Ver todos os ${children.length} paciente(s)`
    },
    {
      title: "Relatórios",
      icon: "📊",
    ...
    },
    {
      title: "Habilidades",
      icon: "⭐",
      link: `/skills?childId=${childId}`,
      color: "bg-blue-400 hover:bg-blue-500",
      description: `Acompanhar desenvolvimento de ${selectedChild?.name}`
    }
  ];
